...
namespace PPSAP.Common
{
    ...
    public partial class QuestionQAS
    {
        ...
        {
            return JsonConvert.DeserializeObject<QuestionQAS>(json, PPSAP.Common.Converter.Settings);
        }
    }
    ...
    public static class Serialize
    {
        ...
        {
            return JsonConvert.SerializeObject(self, PPSAP.Common.Converter.Settings);
        }
    }

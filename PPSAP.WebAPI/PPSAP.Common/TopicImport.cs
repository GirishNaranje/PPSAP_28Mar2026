...
namespace PPSAP.Common
{
    ...
    public partial class Topic
    {
        ...
        {
            return JsonConvert.DeserializeObject<Topic>(json, PPSAP.Common.ConverterTopic.Settings);
        }
    }
    ...
    public static class SerializeTopic
    {
        ...
        {
            return JsonConvert.SerializeObject(self, PPSAP.Common.ConverterTopic.Settings);
        }
    }

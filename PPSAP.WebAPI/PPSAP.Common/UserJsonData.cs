...
namespace PPSAP.Common
{
    ...
    public partial class UserJson
    {
        ...
        {
            return JsonConvert.DeserializeObject<UserJson>(json, PPSAP.Common.UserConverter.Settings);
        }
    }
    ...
    public static class UserSerialize
    {
        ...
        {
            return JsonConvert.SerializeObject(self, PPSAP.Common.UserConverter.Settings);
        }
    }

...
namespace PPSAP.WebAPI.Controllers
{
    ...
    {
        [Route("api/AllQuestions/GetQuestions")]
        [HttpPost]
        ...
        [Route("api/AllQuestions/AddQuestion_aftersubmit")]
        [HttpPost]
        public int AddQuestion_aftersubmit(QuestionDetailsDTO questionDetails)
        {
            return BCSCMapperBAL.AddQuestion_aftersubmit(questionDetails);
        }

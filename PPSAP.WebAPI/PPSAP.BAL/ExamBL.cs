...
namespace PPSAP.BAL
{
    public static class ExamBL
    {
        ...
        public static List<int> GetQuestionList(ExamDTO exam)
        {
            ...
            if (exam.ExamType == Convert.ToInt32(ExamManagerEnum.ExamType.QuickMode) || exam.ExamType == Convert.ToInt32(ExamManagerEnum.ExamType.CustomMode) || exam.ExamType == Convert.ToInt32(ExamManagerEnum.ExamType.SpacedRepetition))
            {
                // var globaladjustment = null;
                ...
                else if (exam.ExamType == Convert.ToInt32(ExamManagerEnum.ExamType.CustomMode) || exam.ExamType == Convert.ToInt32(ExamManagerEnum.ExamType.SpacedRepetition))
                {
            ...
            if (createdexamId > 0)
            {
                ...
                if (questionList.Count > 0)
                {
                    ...
                    else if (Convert.ToInt32(ExamManagerEnum.ExamType.SimulatedMode) == objCreateExam.ExamType)
                    {
                        ...
                        //int examattemptid = ExamDAL.updateExamAttempt_AllocatedTime(examObj.ExamId, examObj.UserId, examAttempt);
                    }
                    ...
                    if(Convert.ToInt32(ExamManagerEnum.ExamType.SimulatedMode) == objCreateExam.ExamType)
                    { 
                        int examattemptid1 = ExamDAL.updateExamAttempt_AllocatedTime(examObj.ExamId, examObj.UserId, examAttempt);
                    }

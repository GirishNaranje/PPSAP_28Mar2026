    ...
    public static class ExamDAL
    {
        public static List<ExamHistoryVM> GetExamListView(int? userId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetExamSummary", objSqlParameter))
            {
        ...
        public static int GetExamQuestionDefault(int? examID)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetDefaultQuestion", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static int CreateExam(ExamDTO exam)
        {
            ...
            SqlHelper.ExecuteNonQuery(SqlConnectionProvider.GetConnectionString(DataAccessType.Write), CommandType.StoredProcedure, "PPSAP_CreateExam", arrSqlParameter);
            return int.Parse(arrSqlParameter[arrSqlParameter.Length - 1].Value.ToString());
        }

        public static int updateExamAttempt_AllocatedTime (int ExamId, int UserId, ExamAttemptDTO examAttempt)
        {
            SqlParameter[] arrSqlParameter =
            {
            ...
            arrSqlParameter[arrSqlParameter.Length - 1].Direction = ParameterDirection.Output;
            SqlHelper.ExecuteNonQuery(SqlConnectionProvider.GetConnectionString(DataAccessType.Write), CommandType.StoredProcedure, "PPSAP_updateExamAttempt_AllocatedTime", arrSqlParameter);
            return int.Parse(arrSqlParameter[arrSqlParameter.Length - 1].Value.ToString());
        }
        ...
        public static ExamDTO GetExamBYId(int? examId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetExamById", objSqlParameter))
            {
        ...
        public static List<ExamQuestionDTO> GetAttemptedQuestionDetails_SR(ExamDTO examObj, string selectedQuestionList_string)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAttemptedQuestionDetails_SR", objSqlParameter))
            {
        ...
        public static List<QuestionTypeCountDTO> GetQuestionTypeCount(int? userId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetQuestionType", arrSqlParameter))
            {
        ...
        public static ExamStatusCountVM GetExamStatusCount(ServiceCallVM examService)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAllExamDetails", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static ExamScoreDetailVM GetExamScore(ServiceCallVM examService)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAvrageExamDetails", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static List<DashboardChartVM> GetCumulativeChartDetail(ChartParameterVM chartParameters)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetCumulativePerformanceBySection", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static List<DashboardChartVM> GetPeerChartDetail(ChartParameterVM chartParameters)
        {
            ...
            {
                using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                    SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetCumulativePerformanceBySectionWithPeer", arrSqlParameter))
                {
                    if (objSqlDataReader.HasRows)
                    {
                        while (objSqlDataReader.Read())
        ...
        public static string CheckExamNameAvailable(ExamNameVM examName)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAvailableExamName", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static ExamCountOnExamTypeVM GetExamCountOnExamType(int userId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetExamTypeCountOnUserId", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static List<int> GetSimulatedExamQuestionList(int totalInputQuestion)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetSimulatedExamQuestionList", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static int GetUserStatusIsFirst(ServiceCallVM userService)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetIsFirstUser", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static void UpdateUserStatusIsFirst(ServiceCallVM userService)
        {
            ...
            SqlHelper.ExecuteNonQuery(SqlConnectionProvider.GetConnectionString(DataAccessType.Write), CommandType.StoredProcedure, "PPSAP_UpdateIsFirstUser", arrSqlParameter);
        }
        ...
        public static QuestionCountOnSection GetQuestionTypeCountBySection(QuestionCountOnSection sectionValue)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetQuestionCountSectionWiseWithType", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static string GetUserOptInStatus(ServiceCallVM userService)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetOptInStatus", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static int UpdateUserOptIn(ServiceCallVM userService)
        {
            ...
            int rows = SqlHelper.ExecuteNonQuery(SqlConnectionProvider.GetConnectionString(DataAccessType.Write), CommandType.StoredProcedure, "PPSAP_UpdateUserOptIn", arrSqlParameter);
            return rows;
        }
    }
}

    ...
    public class AdminQuestionPerformanceDAL
    {
        ...
        public static List<AdminQuestionPerformanceVM> AdminQuestionPerformanceDetails(AdminQuestionPerformanceVM queDetails)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAdminQuestionListReport", objSqlParameter))
            {
        ...
        public static int GetAllQuestionCount(AdminQuestionPerformanceVM questionDetails)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAdminQuestionCountReport", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
        ...
        public static List<AdminQuestionPerformanceVM> GetAllQuestionExport(AdminQuestionPerformanceVM questionDetails)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAdminQuestionExportReport", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
        ...
        public static async Task<List<AdminExamQuestionReport>> GetAllAnsweredQuestionExport(AdminQuestionPerformanceVM questionDetails)
        {
            ...
            try
            {
                ...
                //using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                //    SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAllAdminQuestionExportReport", objSqlParameter))
                //{
                //    while (objSqlDataReader.Read())
                //    {
        ...
        {
            string connectionString = ConfigurationManager.ConnectionStrings["PPSAPDBConnection"].ConnectionString;
            ...
            try
            {
                ...
                using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                    SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAllAdminQuestionExportInExcel", objSqlParameter))
                {
                    await Task.Run(() =>
                    {
                ...
                //{
                //    SqlCommand sqlComm = new SqlCommand("PPSAP_GetAllAdminQuestionExportInExcel", conn);
        ...
        public static int GetTableCountExport(AdminQuestionPerformanceVM questionDetails)
        {
            ...
            try
            {
                ...
                using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                    SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetTableCountExportReport", objSqlParameter))
                {
                    while (objSqlDataReader.Read())
                    {
                        tablecount = Convert.ToInt32(objSqlDataReader["NoOfTables"]);

...
namespace PPSAP.DAL
{
    public class AdminIncorrectQuestionDetailsDAL
    {
        ...
        public static int GetAdminQuestionCount(int examId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAdminQuestionCount", arrSqlParameter))
            {
        ...
        public static List<PeerDetailVM> GetAdminPeerDetails(int questionId, int userId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAdminPeerDetails", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static bool GetAdminMarkStatus(int? examId, int? questionId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAdminMarkStatus", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static string GetAdminExamAttemptAnswerText(int? examId, int? questionId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAdminExamAttemptAnswerText", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static QuestionDetails GetAdminQuestionDetails(int? examId, int? questionId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAdminQuestionDetails", arrSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
        ...
        public static QuestionDetails GetAdminQuestionDetails_SR(int? examId, int? questionId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAdminQuestionDetails_SR", arrSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
                    questionDetail.questionId = Convert.ToInt32(objSqlDataReader["questionid"]);
        ...
        public static ExamDTO GetAdminExamBYId(int? examId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAdminExamList", objSqlParameter))
            {

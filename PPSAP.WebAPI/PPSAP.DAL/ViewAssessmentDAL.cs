    ...
    public class ViewAssessmentDAL
    {
        public static List<int> ViewAssessmentDetails(int? examId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetQuestionId", objSqlParameter))
            {
        ...
        public static List<QuestionIdWithCountVM> FilterByQuestions(int? examId, string filter, int noOfRecords, int pageNo)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetExamQuestionByFilter", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
        ...
        public static List<QuestionIdWithExamId> SearchByQuestions(string userId, string searchterm, string filter, int noOfRecords, int pageNo)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_Search_Question_Procedure", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {

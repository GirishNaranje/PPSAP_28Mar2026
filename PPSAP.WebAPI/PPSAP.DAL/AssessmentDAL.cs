...
namespace PPSAP.DAL
{
    ...
    {
        public static List<Choice> GetChoiceBYQuestionIdForBCSCMapper(int? questionId)
        {
        ...
        public static List<Choice> GetChoiceBYQuestionId(int? questionId, int? examId, int? choiceID, int? examAttemptId, SqlConnection gConnection = null)
        {
            List<Choice> choiceList = new List<Choice>();
            ...
            if (choiceID > 0)
            {
                ...
                SqlCommand cmdAttempt = new SqlCommand("PPSAP_GetChoiceBYQuestionId_if", connection);
                    ...
                    if (reader.HasRows)
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            if (obj is DBNull)
                            {
                                ...
                                cmd = new SqlCommand("PPSAP_GetChoiceBYQuestionId_if_if", connection);
                            ...
                            else
                            {
                                ...
                                /*cmd = new SqlCommand("PPSAP_GetChoiceBYQuestionId_if_else1", connection);
                                cmd.CommandType = CommandType.StoredProcedure;
            ...
            else
            {
                ...
                cmd = new SqlCommand("PPSAP_GetChoiceBYQuestionId_else", connection);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@questionId ", questionId));
            }
        ...
        public static int GetFirstQuestion(ExamDTO examObj)
        {
            ...
            connection.Open();
            SqlCommand cmd = new SqlCommand("PPSAP_GetFirstQuestion", connection);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static QuestionDetails GetQuestionDetails(int? examId, int? questionId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetQuestionDetails", arrSqlParameter))
            {
        ...
        public static QuestionDetails GetQuestionDetails_SR(int? examId, int? questionId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetQuestionDetails_SR", arrSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
                    questionDetail.questionId = Convert.ToInt32(objSqlDataReader["questionid"]);
        ...
        public static List<ChoiceImage> GetChoiceImageList(int? choiceId)
        {
            ...
            connection.Open();
            SqlCommand cmd = new SqlCommand("PPSAP_GetChoiceImageList", connection);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static int GetRightChoiceByQuestionId(int questionId, SqlConnection gConnection = null)
        {
            ...
            SqlCommand cmd = new SqlCommand("PPSAP_GetRightChoiceByQuestionId", connection);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(new SqlParameter("@questionId ", questionId));
            using (SqlDataReader reader = cmd.ExecuteReader())
            {
        ...
        public static int UpdateSkipQuestion(ExamSkipQuestionDTO skipQuestion)
        {
            ...
            SqlHelper.ExecuteNonQuery(SqlConnectionProvider.GetConnectionString(DataAccessType.Write), CommandType.StoredProcedure, "PPSAP_UpdateSkipQuestion", arrSqlParameter);
        ...
        public static int UpdateAttemptAnswer(ExamAttemptAnswerDTO attemptAnswer)
        {
            ...
            arrSqlParameter[arrSqlParameter.Length - 1].Direction = ParameterDirection.Output;
            SqlHelper.ExecuteNonQuery(SqlConnectionProvider.GetConnectionString(DataAccessType.Write), CommandType.StoredProcedure, "PPSAP_UpdateAttemptAnswer", arrSqlParameter);
        ...
        public static QuestionDiscussion GetQuestionDiscussion(int questionId, SqlConnection gConnection = null)
        {
            ...
            SqlCommand cmd = new SqlCommand("PPSAP_GetQuestionDiscussion", connection);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(new SqlParameter("@questionId", questionId));
        ...
        public static List<string> GetReferences(int questionId, SqlConnection gConnection = null)
        {
            ...
            SqlCommand cmd = new SqlCommand("PPSAP_GetReferences", connection);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(new SqlParameter("@questionId ", questionId));
        ...
        public static List<string> GetNotes(int questionId, int userId, int examId, SqlConnection gConnection = null)
        {
            ...
            SqlCommand cmd = new SqlCommand("PPSAP_GetNotes", connection);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(new SqlParameter("@questionId", questionId));
        ...
        public static ExamDTO GetExamBYId(int? examId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetExamList", objSqlParameter))
            {
        ...
        public static ExamAttemptAnswerDTO GetExamAttemptAnswer(int questionId, int examAttemptId, SqlConnection gConnection = null)
        {
            ...
            SqlCommand cmd = new SqlCommand("PPSAP_GetExamAttemptAnswer", connection);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(new SqlParameter("@questionId", questionId));
        ...
        public static void AddExamAttemptText(UpdateSkipAnswered notesAnswer)
        {
            ...
            SqlHelper.ExecuteNonQuery(SqlConnectionProvider.GetConnectionString(DataAccessType.Write), CommandType.StoredProcedure, "PPSAP_AddAttemptAnswerText", arrSqlParameter);
        }
        ...
        public static string GetExamAttemptAnswerText(int? examId, int? questionId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetExamAttemptAnswerText", arrSqlParameter))
            {
        ...
        public static void AddExamQuestionNotes(UpdateSkipAnswered notesAnswer)
        {
            ...
            SqlHelper.ExecuteNonQuery(SqlConnectionProvider.GetConnectionString(DataAccessType.Write), CommandType.StoredProcedure, "PPSAP_AddExamQuestionNotes", arrSqlParameter);
        }
        ...
        public static bool GetMarkStatus(int? examId, int? questionId, int userId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetMarkStatus", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static bool AddOrDeleteMarkedQuestion(UpdateSkipAnswered updateMark)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_InsertOrDeleteMark", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static int SetTimeForQuestion(int? attemptId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_SetExamTime", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static void UpdateConsumedTime(int? attemptId, double consumedTime)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_UpdateExamTime", arrSqlParameter))
            {
            }
        }
        ...
        public static int SubmitExam(UpdateSkipAnswered submitExam)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_SubmitExam", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static List<ViewProgressVM> ViewProgress(UpdateSkipAnswered viewProgressData)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetViewProgressDetails", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
        ...
        public static List<PeerDetailVM> GetPeerDetails(int questionId, int userId, int examattemptId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetPeerDetails", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static int GetQuestionCount(int examId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetQuestionCount", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static void UpdateOrAddIncorrectAnswer(IncorrectQuestionDTO incorrectQuestion)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_UpdateOrAddIncorrectQuestion", arrSqlParameter))
            {
            }
        }
        ...
        public static void SaveIsYourAnswer(UpdateSkipAnswered isYourAnswer)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_UpdateIsYourAnswer", arrSqlParameter))
            {
            }
        }
        ...
        public static List<string> GetBCSCExcerptText(int questionId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetBCSCExcerptText", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static string GetTopicByQuestion(int questionId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetTopicByQuestion", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static void UpdateTime(int? attemptId, double consumedTime)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_UpdateTime", arrSqlParameter))
            {
            }
        }
        ...
        new SqlParameter("@QuestionId", Convert.ToInt32(questionId)),
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetQuestionDetails_Search", arrSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
                    questionDetail.questionId = Convert.ToInt32(objSqlDataReader["questionid"]);
        ...
        public static ExamAttemptAnswerDTO GetExamAttemptAnswer_Search(int questionId, int userId)
        {
            ...
            connection.Open();
            SqlCommand cmd = new SqlCommand("PPSAP_GetExamAttemptAnswer_Search", connection);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(new SqlParameter("@questionId ", questionId));
            cmd.Parameters.Add(new SqlParameter("@userId ", userId));
        ...
        public static void UpdateDeleteTopic(SRRecommendedDeleteVM attemptAnswer)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_UpdateDelTopicTable", arrSqlParameter))
            {
            }
            //arrSqlParameter[arrSqlParameter.Length - 1].Direction = ParameterDirection.Output;
            //SqlHelper.ExecuteNonQuery(SqlConnectionProvider.GetConnectionString(DataAccessType.Write), CommandType.StoredProcedure, "PPSAP_UpdateDelTopicTable", arrSqlParameter);
            //object objResult = arrSqlParameter[arrSqlParameter.Length - 1];
            //return int.Parse(arrSqlParameter[arrSqlParameter.Length - 1].Value.ToString());
        }
        ...
        public static int GetAttemptedQuestionCount(int userId, int sessionId, int examAttemptId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAttemptedQuestionCount", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static int GetNewEasynessFactor(int userId, int questionId, int examAttemptId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetEasinessFactor", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())

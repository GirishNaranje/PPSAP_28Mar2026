    ...
    public class BCSCMapperDAL
    {
        public static List<QuestionContentDTO> GetQuestions(int pageIndex, int noOfRecords)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetQestions", objSqlParameter))
            {
        ...
        public static int AddQuestion(QuestionDetailsDTO questionDetails)
        {
            int questionId = 0;
            SqlParameter[] objSqlParameter =
            {
                new SqlParameter("@QuestionTitle", questionDetails.questionTitle),
                new SqlParameter("@Question_References", questionDetails.references),
                new SqlParameter("@id", SqlDbType.Int) { Direction = ParameterDirection.Output } // Define output parameter
            };

            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_InsertQuestion", objSqlParameter))
            {
            }

            questionId = (int)objSqlParameter[2].Value;

            return questionId;
        }
        
        public static int AddQuestionChoice(bool IsRightChoice, int QuestionId, string ChoiceText, string ChoiceSequence)
        {
            int questionId = 0;
            try
            {
                SqlParameter[] objSqlParameter =
                {
                new SqlParameter("@IsRightChoice", IsRightChoice),
                new SqlParameter("@QuestionId", QuestionId),
                new SqlParameter("@ChoiceText", ChoiceText),
                new SqlParameter("@ChoiceSequence", ChoiceSequence),
                new SqlParameter("@id", SqlDbType.Int) { Direction = ParameterDirection.Output } // Define output parameter
            };

                using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                    SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_InsertQuestionChoice", objSqlParameter))
                {
                }

                questionId = (int)objSqlParameter[4].Value;
            }
            catch (Exception ex)
            {
        ...
        public static int AddQuestionDiscussion(string Discussion_text, int QuestionId)
        {
            int questionId = 0;
            try
            {
                SqlParameter[] objSqlParameter =
                {
                new SqlParameter("@Discussion_text", Discussion_text),
                new SqlParameter("@QuestionId", QuestionId),
                new SqlParameter("@id", SqlDbType.Int) { Direction = ParameterDirection.Output } // Define output parameter
            };

                using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                    SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_InsertQuestionDiscussion", objSqlParameter))
                {
                }
        ...
        public static int AddQuestionTopicXWalk(int QuestionId, int topicId)
        {
            int questionId = 0;
            try
            {
                ...
                using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                    SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_InsertQuestionTopicXWalk", objSqlParameter))
                {
                }
        ...
        public static List<QuestionContentDTO> GetQuestionContent(int? questionId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetProgramToTopicDetails", objSqlParameter))
            {
        ...
        public static bool GetButtonStatus(int? questionId, int? subSpecialityId, int? topicId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_Get_BCSCMappingStatus", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
        ...
        public static List<ChapterDTO> GetChapter(int? subspecialtyId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetChapterTDetailsOfSection", objSqlParameter))
            {
        ...
        public static int InsertContent(TopicContentDTO addTopicContent)
        {
            ...
            SqlHelper.ExecuteNonQuery(SqlConnectionProvider.GetConnectionString(DataAccessType.Write), CommandType.StoredProcedure, "PPSAP_InsertBCSCContent", arrSqlParameter);
            return 1;
        }
        ...
        public static List<TopicContentDTO> GetUpdateContent(int? questionId, int? subSpecialityId, int? topicId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetBCSCcontent", objSqlParameter))
            {
        ...
        public static List<QuestionContentDTO> GetQuestionById(int? questionId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetQestionByQuestionId", objSqlParameter))
            {
        ...
        public static List<QuestionContentDTO> GetQuestionByTitle(string questionText, int pageIndex, int noOfRecords, string radioButtonState)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetQuestionByTitle", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
        ...
        public static List<ProgramDTO> GetProgram()
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetPrograms"))
            {
                while (objSqlDataReader.Read())
                {
        ...
        public static List<ProgramDTO> GetSubProgram(int? programId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetSubprogram", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
        ...
        public static List<ProgramDTO> GetSubSpeciality(int? subProgramId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetSubSpeciality", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
        ...
        public static List<ProgramDTO> GetTopicBySubSpec(int? subSpecialityId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetTopicBySubSpec", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
        ...
        public static List<QuestionContentDTO> GetQuesByTopic(int? topicId, int? subSpecialtyId, int? programId, int? subProgramId, int pageIndex, int noOfRecords)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetQuestionByTopicSubSpeciality", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
                    QuestionContentDTO questionObj = new QuestionContentDTO();
        ...
        public static List<QuestionData> GetBCSCQuestDetails(int? questionId, int? subSpecialityId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetBCSCQuestionDetails", objSqlParameter))
            {
        ...
        public static List<SubSpecialityDTO> GetBCSCSectionNumber(int? subSpecialityId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_Get_BCSCPage", objSqlParameter))
            {
        ...
        public static List<ProgramDTO> GetSubSpecFromSpecialityId(int? subSpecialityId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetSubSpecialityFromSpecialityId", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
                    ProgramDTO objTopicBO = new ProgramDTO();
        ...
        public static List<ProgramDTO> GetTopicByTopicId(int? topicId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetTopicByTopicId", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
                    ProgramDTO objTopicBO = new ProgramDTO();

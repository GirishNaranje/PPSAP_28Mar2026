...
namespace PPSAP.DAL
{
    public class SpacedRepetitionDAL
    {
        ...
        public static ExamDTO GetSpacedRepetionExam(int userId, string typeofCategory)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetSpacedRepetitionExam", objSqlParameter))
            {
        ...
        public static ExamStatusCountSRVM GetExamStatusCountSR(int examId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetSpacedRepetitionExamCounters", arrSqlParameter))
            {
        ...
        public static List<SRPerformanceOverviewVM> GetSectionPerformanceOverviewSR(int examId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_SpacedRepetitionPerformanceOverview", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static List<SRPerformanceOverviewChapterVM> GetChapterPerformanceOverviewSR(int examId, int subspecialityId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_SpacedRepetitionPerformanceOverviewChapter", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static List<SRPerformanceOverviewTopicsVM> GetTopicsPerformanceOverviewSR(int examId, string chapterNumber, int subspecialityId, string ChapterName)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_SpacedRepetitionPerformanceOverviewTopic", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static List<SRRecommendedTopicsVM> GetRecommendedTopicsSR(int examId, int UserId)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_SpacedRepetitionRecommendedTopics", arrSqlParameter))
            {
                if (objSqlDataReader.HasRows)
                {
                    while (objSqlDataReader.Read())
        ...
        public static List<SRRecommendedTopicsExportVM> GetRecommendedTopicsExportSR(int ExamId)
        {
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["PPSAPDBConnection"].ConnectionString))
            {
                SqlCommand sqlComm = new SqlCommand("PPSAP_SpacedRepetitionRecommendedTopics", conn);
        ...
        public static int DeleteRecommendedTopic(SRRecommendedTopicsDeletedVM delRecommendedTopic)
        {
            ...
            SqlHelper.ExecuteNonQuery(SqlConnectionProvider.GetConnectionString(DataAccessType.Write), CommandType.StoredProcedure, "PPSAP_DelRecommendedTopic", arrSqlParameter);

    ...
    public class UtilizationReportsDAL
    {
        public static List<UtilizationReportsVM> UtilizationReports(UtilizationReportsVM utilizationReports)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetUtilizationReports", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {
                    ...
                    reportListBO.CustomerId = customerIdObj is DBNull ? string.Empty : Convert.ToString(objSqlDataReader["UserId"]);
        ...
        public static UtilizationReportsVM AtAGlance(UtilizationReportsVM utilizationReports)
        {
            ...
            using (SqlDataReader objSqlDataReader = SqlHelper.ExecuteReader(
                SqlConnectionProvider.GetConnectionString(DataAccessType.Read), CommandType.StoredProcedure, "PPSAP_GetAtAGlance", objSqlParameter))
            {
                while (objSqlDataReader.Read())
                {

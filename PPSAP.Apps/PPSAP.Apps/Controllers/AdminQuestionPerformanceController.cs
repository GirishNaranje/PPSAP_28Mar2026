...
{
    [Authorize]
    public class AdminQuestionPerformanceController : Controller
    {
        ...
        public ActionResult AdminQuestionPerformanceDetails(int year, int NoOfRecords, int PageNo, DateTime? examStartDate = null, DateTime? examCompletedDate = null)
        {
            ...
            string counturl = PPSAPGlobalConstants.SiteWebAPIUrl + "AdminQuestionPerformance/GetAllQuestionCount";
            ...
            try
            {
                try
                {
                    ...
                    string url = PPSAPGlobalConstants.SiteWebAPIUrl + "AdminQuestionPerformance/AdminQuestionPerformanceDetails";
        ...
        public ActionResult ExportToExcel(int year, DateTime? examStartDate = null, DateTime? examCompletedDate = null)
        {
            ...
            string examPostDataJson = JsonConvert.SerializeObject(queDetails);
            string url = PPSAPGlobalConstants.SiteWebAPIUrl + "AdminQuestionPerformance/GetAllQuestionExport";
            string result = HttpProxy.HttpPost(url, examPostDataJson, "application/json; charset=utf-8", "POST");
            ...
            table.Columns.Add("Question Title", typeof(string));
        ...
        public async Task<ActionResult> ExportAllQuestionToExcel(int year, DateTime? examStartDate = null, DateTime? examCompletedDate = null, bool? optOutValue = false)
        {
            ...
            try
            {
                ...
                string examPostDataJson = JsonConvert.SerializeObject(queDetails);
                string url = PPSAPGlobalConstants.SiteWebAPIUrl + "AdminQuestionPerformance/GetTableCountExport";

    ...
    public class NoteBookController : Controller
    {
        ...
        public ActionResult GetQuestions(string chapterName, int? subSpecialtyId, int? noOfRecords = 5, int? pageNo = 1)
        {
            ...
            try
            {
                ...
                string noteBookurl = PPSAPGlobalConstants.SiteWebAPIUrl + "NoteBook/GetNoteBookDetails";
        ...
        public ActionResult GetSectionList()
        {
            ...
            try
            {
                ...
                string sectionurl = PPSAPGlobalConstants.SiteWebAPIUrl + "NoteBook/GetSectionList";
        ...
        public ActionResult GetChapterList(int? subSpecialtyId)
        {
            ...
            try
            {
                ...
                string chapterurl = PPSAPGlobalConstants.SiteWebAPIUrl + "NoteBook/GetChapterList";
        ...
        public ActionResult GetTopicList(string chapterName)
        {
            UserIdentity user = new UserIdentity(System.Web.HttpContext.Current.User.Identity.Name);
            try
            {
                ...
                string topicurl = PPSAPGlobalConstants.SiteWebAPIUrl + "NoteBook/GetTopicList";
                string topicResult = HttpProxy.HttpPost(topicurl, notesPostDataJson, "application/json; charset=utf-8", "POST");
                List<ChapterDetails> topicList = new List<ChapterDetails>();
                topicList = JsonConvert.DeserializeObject<List<ChapterDetails>>(topicResult);
        ...
        public ActionResult AddNotes(int? questionId, string notesText)
        {
            ...
            try
            {
                ...
                string editNotesurl = PPSAPGlobalConstants.SiteWebAPIUrl + "NoteBook/AddNotes";
        ...
        public ActionResult UpdateNotes(int? notesId, int? questionId, string notesText)
        {
            ...
            try
            {
                ...
                string editNotesurl = PPSAPGlobalConstants.SiteWebAPIUrl + "NoteBook/UpdateNotes";
                string editNotesResult = HttpProxy.HttpPost(editNotesurl, notesPostDataJson, "application/json; charset=utf-8", "POST");
        ...
        public ActionResult DeleteNotes(int? notesId, int? questionId)
        {
            ...
            try
            {
                ...
                string deleteNotesurl = PPSAPGlobalConstants.SiteWebAPIUrl + "NoteBook/DeleteNotes";

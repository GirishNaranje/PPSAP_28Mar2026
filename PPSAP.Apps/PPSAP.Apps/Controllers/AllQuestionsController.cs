...
namespace PPSAP.Apps.Controllers
{
    ...
    public class AllQuestionsController : Controller
    {
        ...
        public ActionResult Index(int pageIndex = 1, int noOfRecords = 25)
        {
            ...
            string urlGetExamIdBYUserId = PPSAPGlobalConstants.SiteWebAPIUrl + "AllQuestions/GetQuestions";
        ...
        public ActionResult GetQuestionContent(int? questionId)
        {
            ...
            string urlGetContent = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetQuestionContent";
        ...
        public ActionResult GetChapter(int? subSpecialityId)
        {
            ...
            string urlGetChapterId = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetChapter";
        ...
        public ActionResult GetButtonStatus(int? questionId, int? subSpecialityId, int? topicId)
        {
            ...
            string questionIdJson = JsonConvert.SerializeObject(questionDTO);
            var data = Encoding.UTF8.GetBytes(questionIdJson);
            string urlGetContent = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetButtonStatus";
            string result_GetContent = HttpProxy.HttpPost(urlGetContent, questionIdJson, "application/json; charset=utf-8", "POST");
            bool buttonStatus;
        ...
        public ActionResult GetUpdateContent(int? questionId, int? subSpecialityId, int? topicId)
        {
            ...
            string urlGetContent = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetUpdateContent";
        ...
        public ActionResult InsertContent(int? questionId, int? subSpecialityId, string chapterName, int? topicId, string contentData)
        {
            ...
            string urlGetContent = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/InsertContent";
        ...
        public ActionResult GetQuestionById(int? questionId)
        {
            ...
            string questionIdJson = JsonConvert.SerializeObject(questionDTO);
            var data = Encoding.UTF8.GetBytes(questionIdJson);
            string urlGetQuestions = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetQuestionById";
        ...
        public ActionResult GetQuestionByTitle(string questionText, int pageIndex, int noOfRecords, string radioButtonState)
        {
            ...
            string urlGetQuestions = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetQuestionByTitle";
        ...
        {
            string urlGetProgramId = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetProgram";
        ...
        public ActionResult GetSubProgram(int? programId)
        {
            ...
            string urlGetSubProgram = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetSubProgram";
        ...
        public ActionResult GetSubSpeciality(int? subProgramId)
        {
            ...
            var data = Encoding.UTF8.GetBytes(subSpecialityIdJson);
            string urlGetSubSpeciality = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetSubSpeciality";
        ...
        public ActionResult GetTopicBySubSpec(int? subSpecialityId)
        {
            ...
            string urlGetTopic = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetTopicBySubSpec";
        ...
        public ActionResult GetQuesByTopic(int? topicId, int? subSpecialtyId, int? programId, int? subProgramId, int pageIndex = 1, int noOfRecords = 25)
        {
            ...
            string urlGetQuestions = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetQuesByTopic";
        ...
        public ActionResult GetBCSCSectionNumber(int subSpecialityId)
        {
            ...
            var data = Encoding.UTF8.GetBytes(subTopicIdJson);
            string urlSerNum = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetBCSCSectionNumber";
        ...
        public ActionResult GetBCSCQuestDetails(int? questionId, int? subSpecialityId)
        {
            ...
            string questionIdJson = JsonConvert.SerializeObject(questionDTO);
            var data = Encoding.UTF8.GetBytes(questionIdJson);
            string urlGetContent = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetBCSCQuestDetails";
            string result_GetContent = HttpProxy.HttpPost(urlGetContent, questionIdJson, "application/json; charset=utf-8", "POST");
        ...
        public ActionResult GetSubSpecFromSpecialityId(int? subSpecialityId)
        {
            ...
            var data = Encoding.UTF8.GetBytes(subTopicIdJson);
            string urlGetTopic = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetSubSpecFromSpecialityId";
            string result_GetTopic = HttpProxy.HttpPost(urlGetTopic, subTopicIdJson, "application/json; charset=utf-8", "POST");
            List<ProgramDTO> subTopic = new List<ProgramDTO>();
            subTopic = JsonConvert.DeserializeObject<List<ProgramDTO>>(result_GetTopic);
            return Json(subTopic, JsonRequestBehavior.AllowGet);
        ...
        public ActionResult GetTopicByTopicId(int? topicId)
        {
            ...
            var data = Encoding.UTF8.GetBytes(topicIdJson);
            string urlGetTopic = PPSAPGlobalConstants.SiteWebAPIUrl + "BCSCMapper/GetTopicByTopicId";
        ...
        public ActionResult AddQuestion_aftersubmit(QuestionDetailsDTO questionDetails)
        {
            string questionDetailsJson = JsonConvert.SerializeObject(questionDetails);
            string urlSavequestionDetails = PPSAPGlobalConstants.SiteWebAPIUrl + "AllQuestions/AddQuestion_aftersubmit";
            string result = HttpProxy.HttpPost(urlSavequestionDetails, questionDetailsJson, "application/json; charset=utf-8", "POST");
            if (result == "1")
            {
                TempData["SuccessMessage"] = "Successfully Added Question";
            }
            else
            {
                TempData["ErrorMessage"] = "Error occurred while adding question in Controller";
            }

            return RedirectToAction("Index", "AllQuestions");
        }

        public ActionResult AddChapterandTopic()
        {
            return View();
        }

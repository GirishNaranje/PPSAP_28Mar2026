        ...
        public ActionResult GetQuestionByFriendly(int? questionid)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    log.Information("questionId:{} userId;{1}", question.questionId, question.userId);

                    // Get Question
                    string urlGetQuestionById = PPSAPGlobalConstants.SiteWebAPIUrl + "UserView/GetQuestionById";

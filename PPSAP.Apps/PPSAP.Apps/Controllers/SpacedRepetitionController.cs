    ...
    public class SpacedRepetitionController : Controller
    {
        ...
        public ActionResult GetExamStatusCountSR()
        {
            try
            {
                ...
                string urlGetExamStatusCountSR = PPSAPGlobalConstants.SiteWebAPIUrl + "spacedRepetition/GetExamStatusCountSR";
        ...
        public ActionResult SRPerformanceOverview()
        {
            try
            {
                ...
                string serviceJson = JsonConvert.SerializeObject(serviceCall);
                string urlGetExamStatusCountSR = PPSAPGlobalConstants.SiteWebAPIUrl + "spacedRepetition/SRPerformanceOverview";
                string resultExamStatusCount = HttpProxy.HttpPost(urlGetExamStatusCountSR, serviceJson, "application/json; charset=utf-8", "POST");
        ...
        public ActionResult SRPerformanceOverviewChapter(string subspecialityId)
        {
            try
            {
                ...
                string serviceJson = JsonConvert.SerializeObject(serviceCall);
                string urlGetExamStatusCountSR = PPSAPGlobalConstants.SiteWebAPIUrl + "spacedRepetition/SRPerformanceOverviewChapter";
                string resultExamStatusCount = HttpProxy.HttpPost(urlGetExamStatusCountSR, serviceJson, "application/json; charset=utf-8", "POST");
        ...
        public ActionResult SRPerformanceOverviewTopics(string chapterNumber, int subspecialityId, string ChapterName)
        {
            try
            {
                ...
                string serviceJson = JsonConvert.SerializeObject(serviceCall);
                string urlGetExamStatusCountSR = PPSAPGlobalConstants.SiteWebAPIUrl + "spacedRepetition/SRPerformanceOverviewTopics";
                string resultExamStatusCount = HttpProxy.HttpPost(urlGetExamStatusCountSR, serviceJson, "application/json; charset=utf-8", "POST");
        ...
        public ActionResult SRRecommendedTopics()
        {
            try
            {
                ...
                log.Information("userId:{0}", serviceCall.userId);
                string serviceJson = JsonConvert.SerializeObject(serviceCall);
                string urlGetExamStatusCountSR = PPSAPGlobalConstants.SiteWebAPIUrl + "spacedRepetition/SRRecommendedTopics";
                string resultExamStatusCount = HttpProxy.HttpPost(urlGetExamStatusCountSR, serviceJson, "application/json; charset=utf-8", "POST");
        ...
        public ActionResult ExportToExcel()
        {
            try
            {
                ...
                string url = PPSAPGlobalConstants.SiteWebAPIUrl + "spacedRepetition/SRRecommendedTopics";
        ...
        public ActionResult DeleteTopic(SRRecommendedTopicsDeletedVM delRecommendedTopic)
        {
            ...
            try
            {
                ...
                string url = PPSAPGlobalConstants.SiteWebAPIUrl + "spacedRepetition/SRRecommendedDelete";

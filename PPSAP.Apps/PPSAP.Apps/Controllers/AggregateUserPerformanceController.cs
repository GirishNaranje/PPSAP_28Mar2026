...
{
    [Authorize]
    public class AggregateUserPerformanceController : Controller
    {
        ...
        public ActionResult AdminReportDetails(int year, DateTime? examStartDate = null, DateTime? examCompletedDate = null)
        {
            ...
            try
            {
                ...
                AdminReportVM reportDetails = new AdminReportVM()
                {
                    ...
                    OrderBy = "subspecialty_name",
                    Seq = "asc",
                };
                string examPostDataJson = JsonConvert.SerializeObject(reportDetails);
                string url = PPSAPGlobalConstants.SiteWebAPIUrl + "AggregateUserPerformance/AdminReportDetails";
        ...
        public ActionResult ExportToExcel(int year, DateTime? examStartDate = null, DateTime? examCompletedDate = null)
        {
            AdminReportVM reportDetails = new AdminReportVM()
            {
                ExamStartDate = DateTime.Today.AddYears(-1),
                ExamCompletedDate = DateTime.Today,
                Year = Convert.ToInt32(year),
            };

            string examPostDataJson = JsonConvert.SerializeObject(reportDetails);
            string url = PPSAPGlobalConstants.SiteWebAPIUrl + "AggregateUserPerformance/AdminReportDetailsExport";
            string result = HttpProxy.HttpPost(url, examPostDataJson, "application/json; charset=utf-8", "POST");
            ...
            table.Columns.Add("No of User attempted this section", typeof(int));
        ...
        public ActionResult GetPYGYear()
        {
            ...
            string urlpgy = PPSAPGlobalConstants.SiteWebAPIUrl + "AggregateUserPerformance/GetPYGYear";
